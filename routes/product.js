...
router.get('/add',function(req, res, next) {
  console.log("123");
    res.render('product/product_add');
...
router.get('/edit/:id', async (req, res) => {
  ...
  try {
    ...
    res.render('product/product_edit', { db_rows_array: result });
  } catch (error) {
...
router.get('/display', async (req, res) => {
  try {
    ...
    res.render('product/product_display', { db_rows_array: documents});
...
router.get('/show/:id', async (req, res) => {
  ...
  try {
    ...
    // Render an HTML page with the data for editing
    res.render('product/product_show', { db_rows_array: result });
  } catch (error) {
    console.error('Error:', error);
    res.status(500).send('Internal Server Error');
  } finally {
